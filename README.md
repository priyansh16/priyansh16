...
- **Production-Grade ML:** Building end-to-end machine learning lifecycles, from data acquisition to deployment via RESTful APIs using Flask, AWS, and Docker.
- **Behavioral Modeling:** Expert in unsupervised learning (NMF, GMM) for tracking entity evolution and "look-alike" profiling.
  
- **Scalable Data Engineering:** Designing high-throughput observability pipelines (Kafka, Snowflake, Airflow) to support 250k+ users.

- **Statistical Integrity:** Passionate about model governance, handling imbalanced datasets, and detecting distribution shifts.

### Key Open Source & Research
